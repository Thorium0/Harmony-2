...
load_dotenv()
BASE_URL = str(environ.get("DOMAIN"))
...
CORS_ALLOWED_ORIGIN_REGEXES=['http://localhost:8080', 'http://5.103.162.10:8080', 'http://thorium.ddns.net:8080', 'http://10.142.109.181:8080']
